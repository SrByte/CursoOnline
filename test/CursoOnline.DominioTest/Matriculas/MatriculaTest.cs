...
namespace CursoOnline.DominioTest.Matriculas
{
    public class MatriculaTest
    {
        ...
        {
            const decimal valorPagoInvalido = 0;
        ...
        {
            const decimal notaDoAlunoEsperada = 9.5m;
        ...
        [InlineData(-1)]
        [InlineData(11)]
        public void NaoDeveInformarComNotaInvalida(decimal notaDoAlunoInvalida)
        {
            var matricula = MatriculaBuilder.Novo().Build();
