...
namespace CursoOnline.DominioTest.Cursos
{
    public class CursoTest
    {
        ...
        public CursoTest()
        {
            ...
            _valor = _faker.Random.Decimal(100, 1000);
        ...
        [InlineData(-2)]
        [InlineData(-100)]
        public void NaoDeveCursoTerUmaCargaHorariaInvalida(int cargaHorariaInvalida)
        {
            Assert.Throws<ExcecaoDeDominio>(() =>
        ...
        [InlineData(-2)]
        [InlineData(-100)]
        public void NaoDeveCursoTerUmaUmValorInvalido(decimal valorInvalido)
        {
            Assert.Throws<ExcecaoDeDominio>(() =>
        ...
        {
            var cargaHorariaEsperada = 20.5m;
            var curso = CursoBuilder.Novo().Build();
        ...
        [InlineData(-2)]
        [InlineData(-100)]
        public void NaoDeveAlterarComCargaHorariaInvalida(decimal cargaHorariaInvalida)
        {
            var curso = CursoBuilder.Novo().Build();
